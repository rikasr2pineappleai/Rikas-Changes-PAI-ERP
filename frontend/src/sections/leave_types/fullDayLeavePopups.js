        ...
        <div className="fd-content-box">
          ...
          <div className="fd-status-proof-row">
            ...
            <div className="fd-proof-column">
              ...
              {documentNotice && (
                <p className="fd-document-notice">
                  {documentNotice}
                </p>
              )}
            </div>
          ...
          >
            ...
            <input
              ...
              className={`fd-reject-input ${rejectedReasonError ? "error" : ""}`}
              type="text"
              ...
              aria-invalid={!!rejectedReasonError}
              aria-describedby={rejectedReasonError ? "fd-reject-reason-error" : undefined}
            />
            {rejectedReasonError && (
              <p id="fd-reject-reason-error" className="fd-reject-error" role="alert">
                {rejectedReasonError}
              </p>
            )}
          </div>
