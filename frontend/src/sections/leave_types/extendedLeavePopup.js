...
export default function ExtendedLeavePopup({ data, onClose, onRefresh }) {
  ...
  return (
    <div className="el-popup-overlay">
      <div className="el-popup-box">
        ...
        {/* PROFILE */}
        <img src={data.image || profile} className="el-profile-img" alt="profile" onError={(e) => {
